    ...
    public class ReportController : BaseController
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var accountReceipts = _unitOfWork.CrCasAccountReceipt.FindAll(x => x.CrCasAccountReceiptLessorCode == lessorCode &&
                                                                            ...
                                                                            new[] { "CrCasAccountReceiptPaymentMethodNavigation", "CrCasAccountReceiptReferenceTypeNavigation", "CrCasAccountReceiptSalesPointNavigation" }).ToList();
        ...
        public async Task<PartialViewResult> GetReceiptsByStatus(string status, string StartDate, string EndDate, string branchCode)
        {
            ...
            var accountReceipts = _unitOfWork.CrCasAccountReceipt.FindAll(x => x.CrCasAccountReceiptLessorCode == lessorCode &&
                                                                            ...
                                                                            x.CrCasAccountReceiptUser == userLogin.CrMasUserInformationCode,
                                                                            new[] { "CrCasAccountReceiptPaymentMethodNavigation", "CrCasAccountReceiptReferenceTypeNavigation", "CrCasAccountReceiptSalesPointNavigation" }).OrderBy(x => x.CrCasAccountReceiptDate).ToList();
