        ...
        public async Task<IActionResult> AdminstritiveProcedures()
        {
            ...
            foreach (var item in model)
            {
                ...
                if (item.CrCasSysAdministrativeProceduresCode == "212")
                {
                    ...
                    var docCar = _unitOfWork.CrCasCarDocumentsMaintenance.Find(x => x.CrCasCarDocumentsMaintenanceProcedures.Trim() == item.CrCasSysAdministrativeProceduresTargeted.Trim()&&
                                                                                    x.CrCasCarDocumentsMaintenanceSerailNo==item.CrCasSysAdministrativeProceduresDocNo && 
                                                                                    x.CrCasCarDocumentsMaintenanceLessor == lessorCode);
                    var procedure = _unitOfWork.CrMasSysProcedure.Find(x => x.CrMasSysProceduresCode == item.CrCasSysAdministrativeProceduresTargeted);
                    if (docCar != null)
                    {
                        item.NameOfTargetAr = $"{item.CrCasSysAdministrativeProceduresCodeNavigation.CrMasSysProceduresArName} ({procedure.CrMasSysProceduresArName}) ({docCar.CrCasCarDocumentsMaintenanceSerailNo})";
                        item.NameOfTargetEn = $"{item.CrCasSysAdministrativeProceduresCodeNavigation.CrMasSysProceduresEnName} ({procedure.CrMasSysProceduresEnName}) ({docCar.CrCasCarDocumentsMaintenanceSerailNo})";
                    }
                }
                if (item.CrCasSysAdministrativeProceduresCode == "213")
                {
                    // if 213 then it is docCar
                    var maintanceCar = _unitOfWork.CrCasCarDocumentsMaintenance.Find(x => x.CrCasCarDocumentsMaintenanceProcedures.Trim() == item.CrCasSysAdministrativeProceduresTargeted.Trim()&&
                                                                                          x.CrCasCarDocumentsMaintenanceSerailNo == item.CrCasSysAdministrativeProceduresDocNo
                                                                                          && x.CrCasCarDocumentsMaintenanceLessor == lessorCode);
                    var procedure = _unitOfWork.CrMasSysProcedure.Find(x => x.CrMasSysProceduresCode == item.CrCasSysAdministrativeProceduresTargeted);
                    if (maintanceCar != null)
                    {
                        item.NameOfTargetAr = $"{item.CrCasSysAdministrativeProceduresCodeNavigation.CrMasSysProceduresArName} ({procedure.CrMasSysProceduresArName}) ({maintanceCar.CrCasCarDocumentsMaintenanceSerailNo})";
                        item.NameOfTargetEn = $"{item.CrCasSysAdministrativeProceduresCodeNavigation.CrMasSysProceduresEnName} ({procedure.CrMasSysProceduresEnName}) ({maintanceCar.CrCasCarDocumentsMaintenanceSerailNo})";
                    }
                }
