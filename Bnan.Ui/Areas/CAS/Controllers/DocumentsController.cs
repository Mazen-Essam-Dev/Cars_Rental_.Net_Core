...
namespace Bnan.Ui.Areas.CAS.Controllers
{
    ...
    public class DocumentsController : BaseController
    {
        ...
        public async Task<IActionResult> Edit([FromQuery] string Procedureid, [FromQuery] string BranchId)
        {
            ...
            if (BranchDocumentVM.CrCasBranchDocumentsStatus == Status.Expire || BranchDocumentVM.CrCasBranchDocumentsStatus == Status.Renewed)
            {
                ViewBag.date = null;
                ViewBag.startDate = null;
                ViewBag.endDate = null;
                BranchDocumentVM.CrCasBranchDocumentsNo = null;
                BranchDocumentVM.CrCasBranchDocumentsDate = null;
                BranchDocumentVM.CrCasBranchDocumentsStartDate = null;
                BranchDocumentVM.CrCasBranchDocumentsEndDate = null;
                BranchDocumentVM.CrCasBranchDocumentsImage = null;
            }
