...
/*    [ServiceFilter(typeof(SessionAuthorizationFilter))]*/
    public class HomeController : BaseController
    {
        ...
        public HomeController(IStringLocalizer<HomeController> localizer,UserManager<CrMasUserInformation> userManager, IUnitOfWork unitOfWork, IMapper mapper) : base(userManager, unitOfWork, mapper)
        {
