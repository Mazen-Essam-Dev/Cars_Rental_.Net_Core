...
namespace Bnan.Ui.ViewModels.CAS
{
    public class AdmintritiveCustodyVM
    {
        ...
        public string? UserSendCustodyAr { get; set; }
        public string? UserSendCustodyEm { get; set; }
        ...
        public virtual CrCasBranchInformation? BranchInformationNavigation { get; set; }
