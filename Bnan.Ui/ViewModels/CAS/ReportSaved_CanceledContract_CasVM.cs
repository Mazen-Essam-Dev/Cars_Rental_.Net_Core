...
{
    public class Date_ReportSaved_CanceledContract_CasVM
    {
        public DateTime? dates { get; set; }
    }
    public class listReportSaved_CanceledContract_CasVM
    {
        public List<ReportSaved_CanceledContract_CasVM> all_contractBasic = new List<ReportSaved_CanceledContract_CasVM>();
    ...
    public class ReportSaved_CanceledContract_CasVM
    {
