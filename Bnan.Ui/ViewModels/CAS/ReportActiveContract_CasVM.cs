...
{
    public class Date_ReportActiveContract_CasVM
    {
        public DateTime? dates { get; set; }
    }
    public class Date_status_ContractVM
    {
    ...
    public class listReportActiveContract_CasVM
    {
        public List<ReportActiveContract_CasVM> all_contractBasic = new List<ReportActiveContract_CasVM>();
        public List<CrMasLessorInformation> all_lessors = new List<CrMasLessorInformation>();
        public List<Date_status_ContractVM> all_status = new List<Date_status_ContractVM>();
    ...
    public class ReportActiveContract_CasVM
    {
