...
{
    public class Date_ReportSaved_CanceledContractVM
    {
        public DateTime? dates { get; set; }
    }
    public class listReportSaved_CanceledContractVM
    {
        public List<ReportSaved_CanceledContractVM> all_contractBasic = new List<ReportSaved_CanceledContractVM>();
    ...
    public class ReportSaved_CanceledContractVM
    {
