...
namespace Bnan.Core.Models
{
    public partial class BnanSCContext : IdentityDbContext<CrMasUserInformation>
    {
        ...
        public virtual DbSet<CrCasAccountInvoice> CrCasAccountInvoices { get; set; } = null!;
        ...
        public virtual DbSet<CrCasRenterContractAuthrorizationCountry> CrCasRenterContractAuthrorizationCountries { get; set; } = null!;
        ...
        public virtual DbSet<CrCasRenterContractEvaluation> CrCasRenterContractEvaluations { get; set; } = null!;
        public virtual DbSet<CrCasRenterContractShomoo> CrCasRenterContractShomoos { get; set; } = null!;
        ...
        public virtual DbSet<CrMasSupCarOil> CrMasSupCarOils { get; set; } = null!;
        ...
        public virtual DbSet<CrMasSysAuthorizationCountry> CrMasSysAuthorizationCountries { get; set; } = null!;
        public virtual DbSet<CrMasSysCallingKey> CrMasSysCallingKeys { get; set; } = null!;
        public virtual DbSet<CrMasSysConvertNoToText> CrMasSysConvertNoToTexts { get; set; } = null!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CrCasAccountBank>(entity =>
            {
                ...
                entity.Property(e => e.CrCasAccountBankCurrent).HasColumnName("CR_Cas_Account_Bank_Current");
                ...
                entity.Property(e => e.CrCasAccountBankSdad).HasColumnName("CR_Cas_Account_Bank_Sdad");
            ...
            modelBuilder.Entity<CrCasAccountInvoice>(entity =>
            {
                entity.HasKey(e => e.CrCasAccountInvoiceNo);

                entity.ToTable("CR_Cas_Account_Invoice");

                entity.Property(e => e.CrCasAccountInvoiceNo)
                    .HasMaxLength(22)
                    .IsUnicode(false)
                    .HasColumnName("CR_Cas_Account_Invoice_No")
                    .IsFixedLength();

                entity.Property(e => e.CrCasAccountInvoicePdfFile)
                    .HasMaxLength(100)
                    .HasColumnName("CR_Cas_Account_Invoice_PDF_File");

                entity.Property(e => e.CrCasAccountInvoiceBranchCode)
                    .HasMaxLength(3)
                    .IsUnicode(false)
                    .HasColumnName("CR_Cas_Account_Invoice_Branch_Code")
                    .IsFixedLength();

                entity.Property(e => e.CrCasAccountInvoiceDate)
                    .HasColumnType("datetime")
                    .HasColumnName("CR_Cas_Account_Invoice_Date");

                entity.Property(e => e.CrCasAccountInvoiceLessorCode)
                    .HasMaxLength(4)
                    .IsUnicode(false)
                    .HasColumnName("CR_Cas_Account_Invoice_Lessor_Code")
                    .IsFixedLength();

                entity.Property(e => e.CrCasAccountInvoiceReferenceContract)
                    .HasMaxLength(22)
                    .IsUnicode(false)
                    .HasColumnName("CR_Cas_Account_Invoice_Reference_Contract")
                    .IsFixedLength();

                entity.Property(e => e.CrCasAccountInvoiceReferenceReceipt)
                    .HasMaxLength(22)
                    .IsUnicode(false)
                    .HasColumnName("CR_Cas_Account_Invoice_Reference_Receipt")
                    .IsFixedLength();

                entity.Property(e => e.CrCasAccountInvoiceType)
                    .HasMaxLength(3)
                    .IsUnicode(false)
                    .HasColumnName("CR_Cas_Account_Invoice_Type")
                    .IsFixedLength();

                entity.Property(e => e.CrCasAccountInvoiceUserCode)
                    .HasMaxLength(10)
                    .IsUnicode(false)
                    .HasColumnName("CR_Cas_Account_Invoice_User_Code");

                entity.Property(e => e.CrCasAccountInvoiceYear)
                    .HasMaxLength(2)
                    .IsUnicode(false)
                    .HasColumnName("CR_Cas_Account_Invoice_Year")
                    .IsFixedLength();

                entity.HasOne(d => d.CrCasAccountInvoiceReferenceReceiptNavigation)
                    .WithMany(p => p.CrCasAccountInvoices)
                    .HasForeignKey(d => d.CrCasAccountInvoiceReferenceReceipt)
                    .HasConstraintName("fk_CR_Cas_Account_Invoice_CR_Cas_Account_Receipt");

                entity.HasOne(d => d.CrCasAccountInvoiceUserCodeNavigation)
                    .WithMany(p => p.CrCasAccountInvoices)
                    .HasForeignKey(d => d.CrCasAccountInvoiceUserCode)
                    .HasConstraintName("fk_CR_Cas_Account_Invoice_CR_Mas_User_Information_Code");

                entity.HasOne(d => d.CrCasAccountInvoiceNavigation)
                    .WithMany(p => p.CrCasAccountInvoices)
                    .HasPrincipalKey(p => new { p.CrCasBranchInformationCode, p.CrCasBranchInformationLessor })
                    .HasForeignKey(d => new { d.CrCasAccountInvoiceBranchCode, d.CrCasAccountInvoiceLessorCode })
                    .HasConstraintName("fk_CR_Cas_Account_Invoice_CR_Cas_Branch_Information");
            });
            ...
            modelBuilder.Entity<CrCasAccountReceipt>(entity =>
            {
                ...
                entity.Property(e => e.CrCasAccountReceiptBranchUserPreviousBalance)
                    .HasColumnType("decimal(13, 2)")
                    .HasColumnName("CR_Cas_Account_Receipt_Branch_User_Previous_Balance");
            ...
            modelBuilder.Entity<CrCasBranchInformation>(entity =>
            {
                ...
                entity.Property(e => e.CrCasBranchInformationShomoosBranchAr)
                    .HasMaxLength(20)
                    .HasColumnName("CR_Cas_Branch_Information_Shomoos_Branch_Ar");

                entity.Property(e => e.CrCasBranchInformationShomoosBranchEn)
                    .HasMaxLength(20)
                    .HasColumnName("CR_Cas_Branch_Information_Shomoos_Branch_En");

                entity.Property(e => e.CrCasBranchInformationShomoosCode).HasColumnName("CR_Cas_Branch_Information_Shomoos_Code");

                entity.Property(e => e.CrCasBranchInformationShomoosSecret).HasColumnName("CR_Cas_Branch_Information_Shomoos_Secret");
                ...
                entity.Property(e => e.CrCasBranchInformationTgaCode).HasColumnName("CR_Cas_Branch_Information_TGA_Code");
            ...
            modelBuilder.Entity<CrCasCarInformation>(entity =>
            {
                ...
                entity.Property(e => e.CrCasCarInformationOil)
                    .HasMaxLength(2)
                    .IsUnicode(false)
                    .HasColumnName("CR_Cas_Car_Information_Oil")
                    .IsFixedLength();
                ...
                entity.HasOne(d => d.CrCasCarInformationOilNavigation)
                    .WithMany(p => p.CrCasCarInformations)
                    .HasForeignKey(d => d.CrCasCarInformationOil)
                    .HasConstraintName("FK_CR_Cas_Car_Information_CR_Mas_Sup_Car_Oil");
            ...
            modelBuilder.Entity<CrCasPriceCarBasic>(entity =>
            {
                ...
                entity.Property(e => e.CrCasPriceCarBasicTransferValue)
                    .HasColumnType("decimal(13, 2)")
                    .HasColumnName("CR_Cas_Price_Car_Basic_Transfer_Value");
            ...
            modelBuilder.Entity<CrCasRenterContractAlert>(entity =>
            {
                ...
                entity.Property(e => e.CrCasRenterContractAlertArStatusMsg)
                    .HasMaxLength(50)
                    .HasColumnName("CR_Cas_Renter_Contract_Alert_Ar_Status_Msg");
                ...
                entity.Property(e => e.CrCasRenterContractAlertEnStatusMsg)
                    .HasMaxLength(50)
                    .HasColumnName("CR_Cas_Renter_Contract_Alert_En_Status_Msg");
            ...
            modelBuilder.Entity<CrCasRenterContractAuthrorizationCountry>(entity =>
            {
                entity.HasKey(e => new { e.CrCasRenterContractAuthrorizationCountryNo, e.CrCasRenterContractAuthrorizationCountryLessor, e.CrCasRenterContractAuthrorizationCountryCode });

                entity.ToTable("CR_Cas_Renter_Contract_Authrorization_Country");

                entity.Property(e => e.CrCasRenterContractAuthrorizationCountryNo)
                    .HasMaxLength(22)
                    .IsUnicode(false)
                    .HasColumnName("CR_Cas_Renter_Contract_Authrorization_Country_No")
                    .IsFixedLength();

                entity.Property(e => e.CrCasRenterContractAuthrorizationCountryLessor)
                    .HasMaxLength(4)
                    .IsUnicode(false)
                    .HasColumnName("CR_Cas_Renter_Contract_Authrorization_Country_Lessor")
                    .IsFixedLength();

                entity.Property(e => e.CrCasRenterContractAuthrorizationCountryCode)
                    .HasMaxLength(3)
                    .IsUnicode(false)
                    .HasColumnName("CR_Cas_Renter_Contract_Authrorization_Country_Code")
                    .IsFixedLength();

                entity.HasOne(d => d.CrCasRenterContractAuthrorizationCountryCodeNavigation)
                    .WithMany(p => p.CrCasRenterContractAuthrorizationCountries)
                    .HasForeignKey(d => d.CrCasRenterContractAuthrorizationCountryCode)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_CR_Cas_Renter_Contract_Authrorization_Country_CR_Mas_Sys_Authorization_Countries");

                entity.HasOne(d => d.CrCasRenterContractAuthrorizationCountryLessorNavigation)
                    .WithMany(p => p.CrCasRenterContractAuthrorizationCountries)
                    .HasForeignKey(d => d.CrCasRenterContractAuthrorizationCountryLessor)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_CR_Cas_Renter_Contract_Authrorization_Country_CR_Mas_Lessor_Information");
            });
            ...
            modelBuilder.Entity<CrCasRenterContractBasic>(entity =>
            {
                ...
                entity.Property(e => e.CrCasRenterContractBasicActualAdvantagesValue)
                    .HasColumnType("decimal(13, 2)")
                    .HasColumnName("CR_Cas_Renter_Contract_Basic_Actual_Advantages_Value");
                ...
                entity.Property(e => e.CrCasRenterContractBasicPdfFile)
                    .HasMaxLength(100)
                    .HasColumnName("CR_Cas_Renter_Contract_Basic_PDF_File");

                entity.Property(e => e.CrCasRenterContractBasicPdfTga)
                    .HasMaxLength(100)
                    .HasColumnName("CR_Cas_Renter_Contract_Basic_PDF_TGA");
                ...
                entity.Property(e => e.CrCasRenterContractBasicOwner)
                    .HasMaxLength(20)
                    .IsUnicode(false)
                    .HasColumnName("CR_Cas_Renter_Contract_Basic_Owner");
                ...
                entity.HasOne(d => d.CrCasRenterContractBasic3)
                    .WithMany(p => p.CrCasRenterContractBasics)
                    .HasForeignKey(d => new { d.CrCasRenterContractBasicOwner, d.CrCasRenterContractBasicLessor })
                    .HasConstraintName("fk_CR_Cas_Renter_Contract_Basic_CR_Cas_Owners");
                ...
                entity.HasOne(d => d.CrCasRenterContractBasic5)
                    .WithMany(p => p.CrCasRenterContractBasicCrCasRenterContractBasic5s)
            ...
            modelBuilder.Entity<CrCasRenterContractCarCheckup>(entity =>
            {
                ...
                entity.Property(e => e.CrCasRenterContractCarCheckupCheck)
                    .HasMaxLength(2)
                    .IsUnicode(false)
                    .HasColumnName("CR_Cas_Renter_Contract_Car_Checkup_Check")
                    .IsFixedLength();
                ...
                entity.HasOne(d => d.CrCasRenterContractCarCheckupC)
                    .WithMany(p => p.CrCasRenterContractCarCheckups)
                    .HasForeignKey(d => new { d.CrCasRenterContractCarCheckupCode, d.CrCasRenterContractCarCheckupCheck })
                    .HasConstraintName("FK_CR_Cas_Renter_Contract_Car_Checkup_CR_Mas_Sup_Contract_Car_Checkup_Details");
            });
            ...
            modelBuilder.Entity<CrCasRenterContractEvaluation>(entity =>
            {
                entity.HasKey(e => new { e.CrCasRenterContractEvaluationContract, e.CrCasRenterContractEvaluationType });

                entity.ToTable("CR_Cas_Renter_Contract_Evaluation");

                entity.Property(e => e.CrCasRenterContractEvaluationContract)
                    .HasMaxLength(22)
                    .IsUnicode(false)
                    .HasColumnName("CR_Cas_Renter_Contract_Evaluation_Contract")
                    .IsFixedLength();

                entity.Property(e => e.CrCasRenterContractEvaluationType)
                    .HasMaxLength(10)
                    .IsUnicode(false)
                    .HasColumnName("CR_Cas_Renter_Contract_Evaluation_Type")
                    .IsFixedLength();

                entity.Property(e => e.CrCasRenterContractEvaluationCode)
                    .HasMaxLength(2)
                    .IsUnicode(false)
                    .HasColumnName("CR_Cas_Renter_Contract_Evaluation_Code")
                    .IsFixedLength();

                entity.Property(e => e.CrCasRenterContractEvaluationDate)
                    .HasColumnType("date")
                    .HasColumnName("CR_Cas_Renter_Contract_Evaluation_Date");

                entity.Property(e => e.CrCasRenterContractEvaluationLessor)
                    .HasMaxLength(4)
                    .IsUnicode(false)
                    .HasColumnName("CR_Cas_Renter_Contract_Evaluation_Lessor")
                    .IsFixedLength();

                entity.Property(e => e.CrCasRenterContractEvaluationReasons)
                    .HasMaxLength(100)
                    .HasColumnName("CR_Cas_Renter_Contract_Evaluation_Reasons");

                entity.Property(e => e.CrCasRenterContractEvaluationRenter)
                    .HasMaxLength(20)
                    .HasColumnName("CR_Cas_Renter_Contract_Evaluation_Renter");

                entity.Property(e => e.CrCasRenterContractEvaluationUser)
                    .HasMaxLength(10)
                    .IsUnicode(false)
                    .HasColumnName("CR_Cas_Renter_Contract_Evaluation_User");

                entity.Property(e => e.CrCasRenterContractEvaluationValue).HasColumnName("CR_Cas_Renter_Contract_Evaluation_Value");

                entity.HasOne(d => d.CrCasRenterContractEvaluationCodeNavigation)
                    .WithMany(p => p.CrCasRenterContractEvaluations)
                    .HasForeignKey(d => d.CrCasRenterContractEvaluationCode)
                    .HasConstraintName("FK_CR_Cas_Renter_Contract_Evaluation_CR_Mas_Sys_Evaluation");

                entity.HasOne(d => d.CrCasRenterContractEvaluationUserNavigation)
                    .WithMany(p => p.CrCasRenterContractEvaluations)
                    .HasForeignKey(d => d.CrCasRenterContractEvaluationUser)
                    .HasConstraintName("FK_CR_Cas_Renter_Contract_Evaluation_CR_Mas_User_Information");

                entity.HasOne(d => d.CrCasRenterContractEvaluationNavigation)
                    .WithMany(p => p.CrCasRenterContractEvaluations)
                    .HasForeignKey(d => new { d.CrCasRenterContractEvaluationRenter, d.CrCasRenterContractEvaluationLessor })
                    .HasConstraintName("FK_CR_Cas_Renter_Contract_Evaluation_CR_Mas_Lessor_Information_CR_Cas_Renter_Lessor");
            });

            modelBuilder.Entity<CrCasRenterContractShomoo>(entity =>
            {
                entity.HasKey(e => e.CrCasRenterContractShomoosContractNo);

                entity.ToTable("CR_Cas_Renter_Contract_Shomoos");

                entity.Property(e => e.CrCasRenterContractShomoosContractNo)
                    .HasMaxLength(22)
                    .IsUnicode(false)
                    .HasColumnName("CR_Cas_Renter_Contract_Shomoos_Contract_No")
                    .IsFixedLength();

                entity.Property(e => e.CrCasRenterContractShomoosAction).HasColumnName("CR_Cas_Renter_Contract_Shomoos_Action");

                entity.Property(e => e.CrCasRenterContractShomoosDaysNo).HasColumnName("CR_Cas_Renter_Contract_Shomoos_Days_No");

                entity.Property(e => e.CrCasRenterContractShomoosEndDate)
                    .HasColumnType("datetime")
                    .HasColumnName("CR_Cas_Renter_Contract_Shomoos_End_Date");

                entity.Property(e => e.CrCasRenterContractShomoosLessor)
                    .HasMaxLength(4)
                    .IsUnicode(false)
                    .HasColumnName("CR_Cas_Renter_Contract_Shomoos_Lessor")
                    .IsFixedLength();

                entity.Property(e => e.CrCasRenterContractShomoosNo)
                    .HasMaxLength(10)
                    .IsUnicode(false)
                    .HasColumnName("CR_Cas_Renter_Contract_Shomoos_No");

                entity.Property(e => e.CrCasRenterContractShomoosStartDate)
                    .HasColumnType("datetime")
                    .HasColumnName("CR_Cas_Renter_Contract_Shomoos_Start_Date");

                entity.Property(e => e.CrCasRenterContractShomoosStatus)
                    .HasMaxLength(1)
                    .IsUnicode(false)
                    .HasColumnName("CR_Cas_Renter_Contract_Shomoos_Status")
                    .IsFixedLength();

                entity.Property(e => e.CrCasRenterContractShomoosType).HasColumnName("CR_Cas_Renter_Contract_Shomoos_Type");

                entity.Property(e => e.CrCasRenterContractShomoosValue)
                    .HasColumnType("decimal(7, 2)")
                    .HasColumnName("CR_Cas_Renter_Contract_Shomoos_Value");

                entity.HasOne(d => d.CrCasRenterContractShomoosLessorNavigation)
                    .WithMany(p => p.CrCasRenterContractShomoos)
                    .HasForeignKey(d => d.CrCasRenterContractShomoosLessor)
                    .HasConstraintName("fk_CR_Cas_Renter_Contract_Shomoos_CR_Mas_Lessor_Information");
            });
            ...
            modelBuilder.Entity<CrMasLessorImage>(entity =>
            {
                ...
                entity.Property(e => e.CrMasLessorImageWhatsupLogo)
                    .HasColumnName("CR_Mas_Lessor_Image_Whatsup_Logo")
                    .HasMaxLength(100);

                entity.Property(e => e.CrMasLessorImageQrCodeSite)
                    .HasColumnName("CR_Mas_Lessor_Image_QrCode_Site")
                    .HasMaxLength(100);

                entity.Property(e => e.CrMasLessorImageAuthenticatedElectronically)
                    .HasColumnName("CR_Mas_Lessor_Image_Authenticated_Electronically")
                    .HasMaxLength(100);

                entity.Property(e => e.CrMasLessorImageQrCodeAuthenticated)
                    .HasColumnName("CR_Mas_Lessor_Image_QrCode_Authenticated")
                    .HasMaxLength(100);

                entity.Property(e => e.CrMasLessorImageMangerSignture)
                    .HasColumnName("CR_Mas_Lessor_Image_Manger_Signture")
                    .HasMaxLength(100);

                entity.Property(e => e.CrMasLessorImageContractCard)
                    .HasColumnName("CR_Mas_Lessor_Image_ContractCard")
                    .HasMaxLength(100);

                entity.Property(e => e.CrMasLessorImagePerformInvoice)
                    .HasColumnName("CR_Mas_Lessor_Image_Perform_Invoice")
                    .HasMaxLength(100);

                entity.Property(e => e.CrMasLessorImageTaxInvoice)
                    .HasColumnName("CR_Mas_Lessor_Image_Tax_Invoice")
                    .HasMaxLength(100);
                ...
                entity.Property(e => e.CrMasLessorImageContractPage1)
                    .HasColumnName("CR_Mas_Lessor_Image_Contract_Page_1")
                    .HasMaxLength(100);

                entity.Property(e => e.CrMasLessorImageContractPage2)
                    .HasColumnName("CR_Mas_Lessor_Image_Contract_Page_2")
                    .HasMaxLength(100);

                entity.Property(e => e.CrMasLessorImageContractPage3)
                    .HasColumnName("CR_Mas_Lessor_Image_Contract_Page_3")
                    .HasMaxLength(100);

                entity.Property(e => e.CrMasLessorImageContractPage4)
                    .HasColumnName("CR_Mas_Lessor_Image_Contract_Page_4")
                    .HasMaxLength(100);

                entity.Property(e => e.CrMasLessorImageContractPage5)
                    .HasColumnName("CR_Mas_Lessor_Image_Contract_Page_5")
                    .HasMaxLength(100);

                entity.Property(e => e.CrMasLessorImageContractPage6)
                    .HasColumnName("CR_Mas_Lessor_Image_Contract_Page_6")
                    .HasMaxLength(100);

                entity.Property(e => e.CrMasLessorImageContractPage7)
                    .HasColumnName("CR_Mas_Lessor_Image_Contract_Page_7")
                    .HasMaxLength(100);

                entity.Property(e => e.CrMasLessorImageContractPage8)
                    .HasColumnName("CR_Mas_Lessor_Image_Contract_Page_8")
                    .HasMaxLength(100);

                entity.Property(e => e.CrMasLessorImageContractPage9)
                    .HasColumnName("CR_Mas_Lessor_Image_Contract_Page_9")
                    .HasMaxLength(100);

                entity.Property(e => e.CrMasLessorImageContractPage10)
                    .HasColumnName("CR_Mas_Lessor_Image_Contract_Page_10")
                    .HasMaxLength(100);

                entity.Property(e => e.CrMasLessorImageContractPage11)
                    .HasColumnName("CR_Mas_Lessor_Image_Contract_Page_11")
                    .HasMaxLength(100);

                entity.Property(e => e.CrMasLessorImageContractPage12)
                    .HasColumnName("CR_Mas_Lessor_Image_Contract_Page_12")
                    .HasMaxLength(100);

                entity.Property(e => e.CrMasLessorImageArConditionPage1)
                    .HasColumnName("CR_Mas_Lessor_Image_Ar_Condition_Page_1")
                    .HasMaxLength(100);

                entity.Property(e => e.CrMasLessorImageArConditionPage2)
                    .HasColumnName("CR_Mas_Lessor_Image_Ar_Condition_Page_2")
                    .HasMaxLength(100);

                entity.Property(e => e.CrMasLessorImageArConditionPage3)
                    .HasColumnName("CR_Mas_Lessor_Image_Ar_Condition_Page_3")
                    .HasMaxLength(100);

                entity.Property(e => e.CrMasLessorImageEnConditionPage1)
                   .HasColumnName("CR_Mas_Lessor_Image_En_Condition_Page_1")
                   .HasMaxLength(100);

                entity.Property(e => e.CrMasLessorImageEnConditionPage2)
                    .HasColumnName("CR_Mas_Lessor_Image_En_Condition_Page_2")
                    .HasMaxLength(100);

                entity.Property(e => e.CrMasLessorImageEnConditionPage3)
                    .HasColumnName("CR_Mas_Lessor_Image_En_Condition_Page_3")
                    .HasMaxLength(100);
                entity.Property(e => e.CrMasLessorImageArDailyReport)
                   .HasColumnName("CR_Mas_Lessor_Image_Ar_Daily_Report")
                   .HasMaxLength(100);

                entity.Property(e => e.CrMasLessorImageEnDailyReport)
                    .HasColumnName("CR_Mas_Lessor_Image_En_Daily_Report")
                    .HasMaxLength(100);
            ...
            modelBuilder.Entity<CrMasLessorInformation>(entity =>
            {
                ...
                entity.Property(e => e.CrMasLessorInformationOwnerId)
                    .HasMaxLength(20)
                    .HasColumnName("CR_Mas_Lessor_Information_Owner_Id");
            ...
            modelBuilder.Entity<CrMasLessorMessage>(entity =>
            {
                entity.HasKey(e => e.CrMasLessorMessagesCode);

                entity.ToTable("CR_Mas_Lessor_Messages");

                entity.Property(e => e.CrMasLessorMessagesCode)
                    .HasMaxLength(22)
                    .IsUnicode(false)
                    .HasColumnName("CR_Mas_Lessor_Messages_Code")
                    .IsFixedLength();

                entity.Property(e => e.CrMasLessorMessagesBranch)
                    .HasMaxLength(3)
                    .IsUnicode(false)
                    .HasColumnName("CR_Mas_Lessor_Messages_Branch")
                    .IsFixedLength();

                entity.Property(e => e.CrMasLessorMessagesContent)
                    .HasMaxLength(100)
                    .HasColumnName("CR_Mas_Lessor_Messages_Content");

                entity.Property(e => e.CrMasLessorMessagesDateTime)
                    .HasColumnType("datetime")
                    .HasColumnName("CR_Mas_Lessor_Messages_DateTime");

                entity.Property(e => e.CrMasLessorMessagesFormat)
                    .HasMaxLength(1)
                    .IsUnicode(false)
                    .HasColumnName("CR_Mas_Lessor_Messages_Format")
                    .IsFixedLength();

                entity.Property(e => e.CrMasLessorMessagesId)
                    .HasMaxLength(20)
                    .HasColumnName("CR_Mas_Lessor_Messages_ID");

                entity.Property(e => e.CrMasLessorMessagesLessor)
                    .HasMaxLength(4)
                    .IsUnicode(false)
                ...
                entity.HasOne(d => d.CrMasLessorMessages)
                    .WithMany(p => p.CrMasLessorMessages)
                    .HasForeignKey(d => new { d.CrMasLessorMessagesLessor, d.CrMasLessorMessagesBranch })
                    .HasConstraintName("FK_CR_Mas_Lessor_Messages_CR_Cas_Branch_Information");
            });
            ...
            modelBuilder.Entity<CrMasRenterInformation>(entity =>
            {
                ...
                entity.Property(e => e.CrMasRenterInformationDrivingLicenseNaqlCode).HasColumnName("CR_Mas_Renter_Information_Driving_License_Naql_Code");

                entity.Property(e => e.CrMasRenterInformationDrivingLicenseNaqlId).HasColumnName("CR_Mas_Renter_Information_Driving_License_Naql_Id");
            ...
            modelBuilder.Entity<CrMasRenterPost>(entity =>
            {
                ...
                entity.Property(e => e.CrMasRenterPostLocation)
                    .HasMaxLength(200)
                    .HasColumnName("CR_Mas_Renter_Post_Location");
            ...
            modelBuilder.Entity<CrMasSupAccountPaymentMethod>(entity =>
            {
                ...
                entity.Property(e => e.CrMasSupAccountPaymentMethodNaqlCode).HasColumnName("CR_Mas_Sup_Account_Payment_Method_Naql_Code");

                entity.Property(e => e.CrMasSupAccountPaymentMethodNaqlId).HasColumnName("CR_Mas_Sup_Account_Payment_Method_Naql_Id");
            ...
            modelBuilder.Entity<CrMasSupCarFuel>(entity =>
            {
                ...
                entity.Property(e => e.CrMasSupCarFuelNaqlCode).HasColumnName("CR_Mas_Sup_Car_Fuel_Naql_Code");

                entity.Property(e => e.CrMasSupCarFuelNaqlId).HasColumnName("CR_Mas_Sup_Car_Fuel_Naql_Id");
            ...
            modelBuilder.Entity<CrMasSupCarOil>(entity =>
            {
                entity.HasKey(e => e.CrMasSupCarOilCode);

                entity.ToTable("CR_Mas_Sup_Car_Oil");

                entity.Property(e => e.CrMasSupCarOilCode)
                    .HasMaxLength(2)
                    .IsUnicode(false)
                    .HasColumnName("CR_Mas_Sup_Car_Oil_Code")
                    .IsFixedLength();

                entity.Property(e => e.CrMasSupCarOilArName)
                    .HasMaxLength(30)
                    .HasColumnName("CR_Mas_Sup_Car_Oil_Ar_Name");

                entity.Property(e => e.CrMasSupCarOilEnName)
                    .HasMaxLength(30)
                    .HasColumnName("CR_Mas_Sup_Car_Oil_En_Name");

                entity.Property(e => e.CrMasSupCarOilImage)
                    .HasMaxLength(100)
                    .HasColumnName("CR_Mas_Sup_Car_Oil_Image");

                entity.Property(e => e.CrMasSupCarOilNaqlCode).HasColumnName("CR_Mas_Sup_Car_Oil_Naql_Code");

                entity.Property(e => e.CrMasSupCarOilNaqlId).HasColumnName("CR_Mas_Sup_Car_Oil_Naql_Id");

                entity.Property(e => e.CrMasSupCarOilReasons)
                    .HasMaxLength(100)
                    .HasColumnName("CR_Mas_Sup_Car_Oil_Reasons");

                entity.Property(e => e.CrMasSupCarOilStatus)
                    .HasMaxLength(1)
                    .IsUnicode(false)
                    .HasColumnName("CR_Mas_Sup_Car_Oil_Status")
                    .IsFixedLength();
            });
            ...
            modelBuilder.Entity<CrMasSupCarRegistration>(entity =>
            {
                ...
                entity.Property(e => e.CrMasSupCarRegistrationNaqlCode).HasColumnName("CR_Mas_Sup_Car_Registration_Naql_Code");

                entity.Property(e => e.CrMasSupCarRegistrationNaqlId).HasColumnName("CR_Mas_Sup_Car_Registration_Naql_Id");
            ...
            modelBuilder.Entity<CrMasSupContractAdditional>(entity =>
            {
                ...
                entity.Property(e => e.CrMasSupContractAdditionalByDayContract)
                    .HasMaxLength(1)
                    .IsUnicode(false)
                    .HasColumnName("CR_Mas_Sup_Contract_Additional_By_Day_Contract")
                    .IsFixedLength();
                ...
                entity.Property(e => e.CrMasSupContractAdditionalNaqlCode).HasColumnName("CR_Mas_Sup_Contract_Additional_Naql_Code");
            ...
            modelBuilder.Entity<CrMasSupContractCarCheckupDetail>(entity =>
            {
                entity.HasKey(e => new { e.CrMasSupContractCarCheckupDetailsCode, e.CrMasSupContractCarCheckupDetailsNo });

                entity.ToTable("CR_Mas_Sup_Contract_Car_Checkup_Details");

                entity.Property(e => e.CrMasSupContractCarCheckupDetailsCode)
                    .HasMaxLength(2)
                    .IsUnicode(false)
                    .HasColumnName("CR_Mas_Sup_Contract_Car_Checkup_Details_Code")
                    .IsFixedLength();

                entity.Property(e => e.CrMasSupContractCarCheckupDetailsNo)
                    .HasMaxLength(2)
                    .IsUnicode(false)
                    .HasColumnName("CR_Mas_Sup_Contract_Car_Checkup_Details_No")
                    .IsFixedLength();

                entity.Property(e => e.CrMasSupContractCarCheckupDetailsArName)
                    .HasMaxLength(20)
                    .HasColumnName("CR_Mas_Sup_Contract_Car_Checkup_Details_Ar_Name");

                entity.Property(e => e.CrMasSupContractCarCheckupDetailsEnName)
                    .HasMaxLength(20)
                    .HasColumnName("CR_Mas_Sup_Contract_Car_Checkup_Details_En_Name");

                entity.Property(e => e.CrMasSupContractCarCheckupDetailsReasons)
                    .HasMaxLength(100)
                    .HasColumnName("CR_Mas_Sup_Contract_Car_Checkup_Details_Reasons");

                entity.Property(e => e.CrMasSupContractCarCheckupDetailsStatus)
                    .HasMaxLength(1)
                    .IsUnicode(false)
                    .HasColumnName("CR_Mas_Sup_Contract_Car_Checkup_Details_Status")
                    .IsFixedLength();

                entity.HasOne(d => d.CrMasSupContractCarCheckupDetailsCodeNavigation)
                    .WithMany(p => p.CrMasSupContractCarCheckupDetails)
                    .HasForeignKey(d => d.CrMasSupContractCarCheckupDetailsCode)
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            modelBuilder.Entity<CrMasSupContractOption>(entity =>
            {
                ...
                entity.Property(e => e.CrMasSupContractOptionsByDayContract)
                    .HasMaxLength(1)
                    .IsUnicode(false)
                    .HasColumnName("CR_Mas_Sup_Contract_Options_By_Day_Contract")
                    .IsFixedLength();
                ...
                entity.Property(e => e.CrMasSupContractOptionsNaqlCode).HasColumnName("CR_Mas_Sup_Contract_Options_Naql_Code");
            ...
            modelBuilder.Entity<CrMasSupRenterNationality>(entity =>
            {
                ...
                entity.Property(e => e.CrMasSupRenterNationalitiesNaqlCode).HasColumnName("CR_Mas_Sup_Renter_Nationalities_Naql_Code");

                entity.Property(e => e.CrMasSupRenterNationalitiesNaqlGcc)
                    .HasMaxLength(1)
                    .IsUnicode(false)
                    .HasColumnName("CR_Mas_Sup_Renter_Nationalities_Naql_GCC")
                    .IsFixedLength();

                entity.Property(e => e.CrMasSupRenterNationalitiesNaqlId).HasColumnName("CR_Mas_Sup_Renter_Nationalities_Naql_Id");
            ...
            modelBuilder.Entity<CrMasSysAuthorizationCountry>(entity =>
            {
                entity.HasKey(e => e.CrMasSysAuthorizationCountriesCode)
                    .HasName("PK_CR_Mas_Sys_Country");

                entity.ToTable("CR_Mas_Sys_Authorization_Countries");

                entity.Property(e => e.CrMasSysAuthorizationCountriesCode)
                    .HasMaxLength(3)
                    .IsUnicode(false)
                    .HasColumnName("CR_Mas_Sys_Authorization_Countries_Code")
                    .IsFixedLength();

                entity.Property(e => e.CrMasSysAuthorizationCountriesArName)
                    .HasMaxLength(50)
                    .HasColumnName("CR_Mas_Sys_Authorization_Countries_Ar_Name");

                entity.Property(e => e.CrMasSysAuthorizationCountriesClassificationCode)
                    .HasMaxLength(1)
                    .IsUnicode(false)
                    .HasColumnName("CR_Mas_Sys_Authorization_Countries_Classification_Code")
                    .IsFixedLength();

                entity.Property(e => e.CrMasSysAuthorizationCountriesCount).HasColumnName("CR_Mas_Sys_Authorization_Countries_Count");

                entity.Property(e => e.CrMasSysAuthorizationCountriesEnName)
                    .HasMaxLength(50)
                    .HasColumnName("CR_Mas_Sys_Authorization_Countries_En_Name");

                entity.Property(e => e.CrMasSysAuthorizationCountriesFlag)
                    .HasMaxLength(100)
                    .HasColumnName("CR_Mas_Sys_Authorization_Countries_Flag");

                entity.Property(e => e.CrMasSysAuthorizationCountriesNaqlCode).HasColumnName("CR_Mas_Sys_Authorization_Countries_Naql_Code");

                entity.Property(e => e.CrMasSysAuthorizationCountriesNaqlId).HasColumnName("CR_Mas_Sys_Authorization_Countries_Naql_Id");

                entity.Property(e => e.CrMasSysAuthorizationCountriesReasons)
                    .HasMaxLength(100)
                    .HasColumnName("CR_Mas_Sys_Authorization_Countries_Reasons");

                entity.Property(e => e.CrMasSysAuthorizationCountriesStatus)
                    .HasMaxLength(1)
                    .IsUnicode(false)
                    .HasColumnName("CR_Mas_Sys_Authorization_Countries_Status")
                    .IsFixedLength();
            });
            ...
            modelBuilder.Entity<CrMasSysCallingKey>(entity =>
            {
                ...
                entity.Property(e => e.CrMasSysCallingKeysClassificationCode)
                    .HasMaxLength(1)
                    .IsUnicode(false)
                    .HasColumnName("CR_Mas_Sys_Calling_Keys_Classification_Code")
                    .IsFixedLength();
                ...
                entity.Property(e => e.CrMasSysCallingKeysNaqlCode).HasColumnName("CR_Mas_Sys_Calling_Keys_Naql_Code");

                entity.Property(e => e.CrMasSysCallingKeysNaqlId).HasColumnName("CR_Mas_Sys_Calling_Keys_Naql_Id");
            ...
            modelBuilder.Entity<CrMasSysConvertNoToText>(entity =>
            {
                entity.HasKey(e => new { e.CrMasSysConvertNoToTextCode, e.CrMasSysConvertNoToTextType });

                entity.ToTable("CR_Mas_Sys_Convert_NoToText");

                entity.Property(e => e.CrMasSysConvertNoToTextCode)
                    .HasMaxLength(2)
                    .IsUnicode(false)
                    .HasColumnName("CR_Mas_Sys_Convert_NoToText_Code")
                    .IsFixedLength();

                entity.Property(e => e.CrMasSysConvertNoToTextType)
                    .HasMaxLength(1)
                    .IsUnicode(false)
                    .HasColumnName("CR_Mas_Sys_Convert_NoToText_Type")
                    .IsFixedLength();

                entity.Property(e => e.CrMasSysConvertNoToTextArName)
                    .HasMaxLength(30)
                    .HasColumnName("CR_Mas_Sys_Convert_NoToText_Ar_Name");

                entity.Property(e => e.CrMasSysConvertNoToTextEnName)
                    .HasMaxLength(30)
                    .HasColumnName("CR_Mas_Sys_Convert_NoToText_En_Name");

                entity.Property(e => e.CrMasSysConvertNoToTextReasons)
                    .HasMaxLength(100)
                    .HasColumnName("CR_Mas_Sys_Convert_NoToText_Reasons");

                entity.Property(e => e.CrMasSysConvertNoToTextStatus)
                    .HasMaxLength(1)
                    .IsUnicode(false)
                    .HasColumnName("CR_Mas_Sys_Convert_NoToText_Status")
                    .IsFixedLength();
            });
            ...
            modelBuilder.Entity<CrMasSysQuestionsAnswer>(entity =>
            {
                ...
                entity.Property(e => e.CrMasSysQuestionsAnswerArVideo)
                    .HasMaxLength(100)
                    .HasColumnName("CR_Mas_Sys_Questions_Answer_Ar_Video");
                ...
                entity.Property(e => e.CrMasSysQuestionsAnswerEnVideo)
                    .HasMaxLength(100)
                    .HasColumnName("CR_Mas_Sys_Questions_Answer_En_Video");
            ...
            modelBuilder.Entity<CrMasUserInformation>(entity =>
            {
                ...
                entity.Property(e => e.CrMasUserInformationAlertCreditLimit).HasColumnName("CR_Mas_User_Information_Alert_Credit_Limit");

                entity.Property(e => e.CrMasUserInformationAlertDaysPassWord).HasColumnName("CR_Mas_User_Information_Alert_Days_PassWord");
                ...
                entity.Property(e => e.CrMasUserInformationCreditDaysLimit).HasColumnName("CR_Mas_User_Information_Credit_Days_Limit");
                ...
                entity.Property(e => e.CrMasUserInformationId)
                    .HasMaxLength(20)
                    .HasColumnName("CR_Mas_User_Information_Id");
