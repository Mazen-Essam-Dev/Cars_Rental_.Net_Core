...
namespace Bnan.Inferastructure.Repository
{
    public class TransferToFromRenter : ITransferToFromRenter
    {
            ...
            string lessorCode, string BankNo, string AccountNo, string TotalAmountPayment, string TotalAmountReceipt, string SavePdfReceipt, string reasons)
        {
            ...
            var userValidity = await _unitOfWork.CrMasUserBranchValidity.FindAsync(x => x.CrMasUserBranchValidityLessor == lessorCode && x.CrMasUserBranchValidityBranch == "100" && x.CrMasUserBranchValidityId == User.CrMasUserInformationCode);
            ...
            receipt.CrCasAccountReceiptNo = AccountReceiptNo;
