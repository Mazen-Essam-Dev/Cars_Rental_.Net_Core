...
namespace Bnan.Core.Interfaces
{
    public interface ICustody
    {
        ...
        Task<bool> AddAccountReceiptReceivedCustody(string AdmintritiveNo, string lessorCode, string BranchCode, string Creditor,string userCode,string SavePdfReceipt, string reasons);
        ...
        bool UpdateAccountReceiptReceivedCustody(string AdminstritiveNo,string UserCode,string status, string Reasons);
        Task<bool> UpdateAdminstritive(string AdminstritiveNo, string UserCode, string status, string Reasons);
        string GetAccountReceiptNo(string BranchCode, string LessorCode);
