...
namespace Bnan.Core.Models
{
    public partial class CrMasSupContractCarCheckup
    {
        ...
        {
            CrMasSupContractCarCheckupDetails = new HashSet<CrMasSupContractCarCheckupDetail>();
        }
        ...
        public virtual ICollection<CrMasSupContractCarCheckupDetail> CrMasSupContractCarCheckupDetails { get; set; }
    }
}
